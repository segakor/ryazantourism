...
export const headerMenu = [
  ...
  },
  {
    ...
    subItem: [
      { label: "Что посмотреть?", path: "/istoria" },
      { label: "Чем заняться?", path: "/Культура" },
      { label: "Где поесть?", path: "/Природа" },
      { label: "Где остановиться?", path: "/Кухня Рязанского края" },
      { label: "Сувениры", path: "/Архитектура" },
      { label: "Вечер в городе", path: "/Архитектура" },
      { label: "Здоровье", path: "/Архитектура" },
    ],
  },
  {
    item: "Ты с местными",
