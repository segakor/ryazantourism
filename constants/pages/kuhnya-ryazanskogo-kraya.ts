export const template = [
  {
    ...
    desc: "Вопросом, что бы такого попробовать из местной кухни, задается любой путешественник. В 2018 году ответом всерьез озадачились и рязанские рестораторы. Итогом стал гастрономический фестиваль «Кухня Рязанского края», который теперь проходит каждую весну на площадках ведущих ресторанов города.\n\nКаждый ресторан-участник представляет особый гастрономический сет из региональных продуктов по фиксированной стоимости. Холодная и горячая закуски, первое блюдо, горячее с гарниром и десерт обходятся гостям заведений примерно в полторы тысячи рублей.\n\nЕсли вы решили, что опоздали к раздаче всего самого вкусного, и начали терять интерес, то не расстраивайтесь — лучшие находки входят в постоянное меню заведений и радуют туристов и местных жителей круглый год.",
    /*  srcImg:
