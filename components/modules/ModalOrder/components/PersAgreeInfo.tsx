...
export const PersAgreeInfo = ({ onBack }: Props) => {
  return (
    <div>
      <div
        className="flex text-white cursor-pointer py-2 opacity-70 hover:opacity-100"
        onClick={onBack}
      >
        <svg
      ...
      <ScrollShadow hideScrollBar>
        <div className="h-[676px] text-white py-5">
          ...
          безопасности персональных данных, предпринимаемые АНО Агентство
          развития туризма Рязанской области (далее — Оператор). 1.1. Оператор
          ...
          может получить о посетителях веб-сайта https://ryazantourism.ru/. 2.
          ...
          https://ryazantourism.ru/. 2.4. Информационная система персональных
          ...
          определяемому Пользователю веб-сайта https://ryazantourism.ru/. 2.9.
          ...
          посетитель веб-сайта https://ryazantourism.ru/. 2.11. Предоставление
          ...
          и обезличивание персональных данных 7. Условия обработки персональных
          ...
          уведомление на адрес электронной почты Оператора rzn.visit@yandex.ru с
          ...
          адрес Оператора rzn.visit@yandex.ru с пометкой «Отзыв согласия на
          ...
          почты rzn.visit@yandex.ru. 12.2. В данном документе будут отражены
