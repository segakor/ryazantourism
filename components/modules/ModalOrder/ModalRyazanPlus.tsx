        ...
        <div className="text-white w-full flex md:flex-row flex-col md:p-[5rem] p-4 justify-between md:gap-8 gap-4">
          <div className="flex-1">
            ...
            <div className="text-[1rem] opacity-[0.5]">
              ...
              <br />
              Каждую субботу мы встречаем гостей города на улице Почтовой.
              <br />
              <br />
              Время старта 12.00.
            </div>
                  ...
                  <div className="flex gap-2 justify-between">
                    <>
                      {[1, 2, 3, 4, 5].map((item, index) => (
                        <button
                          type="button"
                          className={`cursor-pointer rounded-xl transition-all p-3 bg-[#998ce4] ${count === item && "!bg-white"
                            }`}
                          key={index}
                          onClick={() => onChangeCount(item)}
                        >
                          <div
                            className={`min-w-[1.875rem] font-medium text-center text-white ${count === item && "!text-black"
                              }`}
                          >
                            {item != 5 ? item : item + "+"}
                          </div>
                ...
                <Field
                  ...
                  render={({ input, meta }) => (
                    <div className="mb-[0.125rem] min-h-[1.5rem] ps-[1.5rem] flex items-center">
                      ...
                      />
                      <label
                        className={`inline-block ps-[0.15rem] text-sm hover:cursor-pointer ${!!meta.touched && !!meta.error && "!text-[#f31260]"
                          }`}
                      >
