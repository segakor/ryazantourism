...
const apple = (
  <svg
    ...
    className="group-hover/item:fill-white fill-[#939291] transition-all"
  >
    <path
...
export const Footer = () => {
  return (
    <footer className="footer bg-[#252525] md:p-20 p-10">
      <div className="max-w-[1280px] m-[0_auto] text-white">
        <div className="flex flex-row flex-wrap gap-10">
          <div className="flex flex-col md:flex-[0_1_240px] flex-1 md:items-start items-center">
            <div className="opacity-60 text-sm mb-5 md:text-start text-center">
              Туристский Информационный Центр Рязанской области
            </div>
            <Link
            ...
            <div>
              ...
              <div className="flex gap-2 md:justify-normal justify-center">
                <Link href={url.apple} target="_blank" className="group/item">
                  {apple}
                </Link>
                <Link href={url.android} target="_blank" className="group/item">
                  {android}
                </Link>
              </div>
            </div>
            <div>
              <div className="opacity-60 text-sm mb-2 mt-10">Мы в соцсетях</div>
              <div className="flex gap-2 md:justify-normal justify-center">
                ...
                <Link href={url.dzen} target="_blank" className="group/item">
                  {dzen}
                </Link>
              </div>
            </div>
          </div>
          <div className="md:flex md:visible hidden flex-col gap-[10px]">
            <Typography variant="h5" className="opacity-50 mb-2">
              {headerMenu[0].item}
            </Typography>
            {headerMenu[0].subItem.map((item, index) => (
              <Link href={item.path} key={index}>
                <Typography
                  variant="h6"
                  className="hover:text-[var(--color-green)] transition-all"
                >
                  {item.label}
                </Typography>
              </Link>
          ...
          <div className="md:flex md:visible hidden flex-col gap-[10px]">
            ...
            {headerMenu[1].subItem.map((item, index) => (
              <Link href={item.path} key={index}>
                <Typography
                  variant="h6"
                  className="hover:text-[var(--color-green)] transition-all"
          ...
          <div className="md:flex md:visible hidden flex-col gap-[10px]">
            ...
            {headerMenu[2].subItem.map((item, index) => (
              <Link href={item.path} key={index}>
                <Typography
                  variant="h6"
                  className="hover:text-[var(--color-green)] transition-all"
            ...
            <Typography variant="h5" className="opacity-50 mb-2 mt-2">
              {headerMenu[3].item}
            </Typography>
            {headerMenu[3].subItem.map((item, index) => (
              <Link href={item.path} key={index}>
                <Typography
                  variant="h6"
                  className="hover:text-[var(--color-green)] transition-all"
          ...
          <div className="md:flex md:visible hidden flex-col gap-[10px]">
            ...
            {headerMenu[4].subItem.map((item, index) => (
              <Link href={item.path} key={index}>
                <Typography
                  variant="h6"
                  className="hover:text-[var(--color-green)] transition-all"
            ...
            {headerMenu[5].subItem.map((item, index) => (
              <Link href={item.path} key={index}>
                <Typography
                  variant="h6"
                  className="hover:text-[var(--color-green)] transition-all"
        ...
        <div className="divider border-t-1 border-white border-solid mt-10 mb-10 opacity-50"></div>
        <div className="flex md:flex-row flex-col justify-between md:items-start items-center md:gap-0 gap-10">
          <div className="flex gap-7 items-center md:flex-[0_1_264px] flex-1">
            {logoFooter}
            <div className="text-sm">
              Все о туризме в Рязани <br /> и Рязанской области
            </div>
          </div>
          <div className="opacity-60 md:text-start text-center text-sm md:flex-[0_1_584px] flex-1">
