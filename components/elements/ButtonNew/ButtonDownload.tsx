...
export const ButtonDownload = ({
  ...
  href: string;
  children: ReactNode;
  variant: "whiteSlate" | "redBlack";
}) => {
  const dictColor = {
    whiteSlate: "bg-[var(--color-white)] hover:bg-[var(--color-green)] ",
    redBlack: "bg-[#FF0033] hover:bg-black ",
  };

  return (
    <Link href={href} target="_blank">
      <div
        className={`group/item ${dictColor[variant]} transition-all py-4 px-5 inline-block rounded-full`}
      >
          ...
          >
            <g clipPath="url(#clip0_635_2484)">
              <path
                ...
                fill="black"
                className="fill-white group-hover/item:fill-white"
              />
              <path
                ...
                className="stroke-white group-hover/item:stroke-white"
              />
            </g>
            <defs>
